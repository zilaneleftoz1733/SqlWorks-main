alter procedure RaporTablosuHazirla (@tableName nvarchar(50))
as 
Begin 
...
select PhoneNumber from IvrPhoneNumber
...
set @sql = 'insert into ##' +@tableName+ ' (Phone) values ('''+@phone+''')' -- tek tirnak olusumuna dikkat
print @sql 
exec (@sql)
FETCH next from cursor_ivrPhone into @phone
End
